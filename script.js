...
// Botones de exportación con visibilidad condicional
const exportVisibilityButtons = document.querySelectorAll('.export-visibility');

function revealExportButtons() {
    exportVisibilityButtons.forEach(btn => btn.classList.remove('hidden'));
}

function hideExportButtons() {
    exportVisibilityButtons.forEach(btn => btn.classList.add('hidden'));
}
...
function loadFromLocalStorage() {
    ...
    if (savedShared) {
        ...
        if (hasShared) revealExportButtons();
    }
